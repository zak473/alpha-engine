...
def purge_bad_ai_tips(
    ...
    """
    Delete all pending AI tipster tips created in the last 6 hours.
    Use this to clean up any bad batch generated by misconfigured thresholds.
    """
    ...
    db.commit()
    logger.info("[admin] purge_bad_ai_tips: deleted %d tips", deleted)
