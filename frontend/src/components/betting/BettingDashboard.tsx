        ...
        <div ref={scrollContainerRef} className="flex-1 overflow-y-auto">
          ...
          <div className="px-4 lg:px-6">
            <section className="grid gap-4 pb-4 xl:grid-cols-[1.15fr_0.85fr]">
              <div className="rounded-[30px] border border-white/8 bg-[#18181b] p-5 lg:p-6">
                  ...
                  {(["all", "soccer", "tennis", "esports", "basketball", "baseball", "hockey"] as Array<SportSlug | "all">).map((entry) => (
                    <button
                      ...
                      className={activeSport === entry
                        ...
                        : "rounded-full border border-white/8 bg-[#27272a] px-4 py-2 text-sm text-white/58"}
                    >
                ...
                <div className="mt-5 grid gap-3 sm:grid-cols-3">
                  <button onClick={handleShowTopPicks} className="rounded-[22px] border border-white/8 bg-[#27272a] p-4 text-left transition hover:border-emerald-300/20">
                  ...
                  <button onClick={handleShowLive} className="rounded-[22px] border border-white/8 bg-[#27272a] p-4 text-left transition hover:border-emerald-300/20">
                  ...
                  <button onClick={handleClearFilters} className="rounded-[22px] border border-white/8 bg-[#27272a] p-4 text-left transition hover:border-emerald-300/20">
