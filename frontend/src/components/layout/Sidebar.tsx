    ...
    <>
      ...
      >
        <div className="px-4 pb-3 pt-4">
          <div className="rounded-[28px] border border-white/10 bg-[#27272a] p-4 shadow-[0_18px_40px_rgba(0,0,0,0.24)]">
            <div className="rounded-[22px] border border-emerald-300/14 bg-[#18181b] p-4">
            ...
            <div className="mt-4 grid grid-cols-2 gap-2">
              {[
                ...
                <div key={label} className="rounded-2xl border border-white/8 bg-[#18181b] px-3 py-3">
