        ...
        >
          {results.map((r) => (
            <Link
              ...
              className="flex items-center gap-3 px-3 py-2.5 hover:bg-[var(--surface-raised)] transition-colors"
            >
              <div
        ...
        <div className="absolute right-0 top-full mt-2 w-80 rounded-2xl border overflow-hidden shadow-xl z-50"
          ...
          <div className="max-h-80 overflow-y-auto">
            {notifications.length === 0 ? (
              ...
              notifications.map(n => (
                <div key={n.id}
                  className="flex items-start gap-3 px-4 py-3 border-b last:border-b-0 hover:bg-[var(--surface-raised)] transition-colors"
